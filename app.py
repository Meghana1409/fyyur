...
class Show(db.Model):
    ...
    def __repr__(self):
        return '<Show {} {} artist_id={} venue_id={}>'.format(self.id,self.start_time,artist_id,venue_id)
...
def create_venue_submission():
    ...
    if not form.validate():
        ...
        try:
            ...
            print('Exception "{}" in create_venue_submission()'.format(e))
            db.session.rollback()
        finally:
            db.session.close()
...
def delete_venue(venue_id):
    ...
    if not venue:
        ...
        try:
            ...
            db.session.close()
        if error_on_delete:
            flash('An error occurred deleting venue {}.'.format(venue_name))
...
def edit_artist_submission(artist_id):
    ...
    if not form.validate():
        ...
        try:
            ...
            print('Exception "{}" in edit_artist_submission()'.format(e))
            db.session.rollback()
        finally:
            db.session.close()
...
def edit_venue_submission(venue_id):
    ...
    if not form.validate():
        ...
        try:
            ...
            error_in_update = True
            print('Exception "{}" in edit_venue_submission()'.format(e))
            db.session.rollback()
        finally:
            db.session.close()
...
def create_artist_submission():
    ...
    if not form.validate():
        ...
        try:
            ...
            error_in_insert = True
            print('Exception "{}" in create_artist_submission()'.format(e))
            db.session.rollback()
        finally:
            db.session.close()
...
def delete_artist(artist_id):
    ...
    if not artist:
        ...
        try:
            ...
            db.session.close()
        if error_on_delete:
            flash('An error occurred deleting artist {}.'.format(artist_name))
...
def create_show_submission():
    ...
    try:
        ...
        error_in_insert = True
        print('Exception "{}" in create_show_submission()'.format(e))
        db.session.rollback()
    finally:
        db.session.close()
